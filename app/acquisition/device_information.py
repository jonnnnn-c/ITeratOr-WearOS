...
def get_device_info():
    ...
    append_to_output_file(output_file_path, f"Android Version: {android_version}")
...
def get_system_log():
    ...
    # append_to_output_file(output_file_path, f"System Log (logcat):\n{logcat_output}")
...
def document_device_state():
    ...
    # Clear the output file at the start of the documentation process
    with open(output_file_path, "w") as f:
        f.write("")  # Clear contents or create new file
